...
typedef struct _GstTagLibMuxPrivClass GstTagLibMuxPrivClass;

/* Definition of structure storing data for this element. */
struct _GstTagLibMuxPriv {
  GstElement    element;
...
struct _GstTagLibMuxPrivClass {
  GstElementClass parent_class;

  /* vfuncs */
  GstBuffer  * (*render_tag) (GstTagLibMuxPriv * mux, GstTagList * tag_list);
};

/* Standard macros for defining types for this element.  */
#define GST_TYPE_TAG_LIB_MUX \
  (gst_tag_lib_mux_priv_get_type())
#define GST_TAG_LIB_MUX(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_TAG_LIB_MUX,GstTagLibMuxPriv))
#define GST_TAG_LIB_MUX_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_TAG_LIB_MUX,GstTagLibMuxPrivClass))
...
GType gst_tag_lib_mux_priv_get_type (void);
